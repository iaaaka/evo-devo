...
index=$SGE_O_HOME/projects/evo.devo/processed/index/Gallus_gallus.Galgal4.dna.toplevel.cleanNames
reads=$SGE_O_HOME/projects/evo.devo/raw/fq.japan.embrio
ids=( $(ls -1 $reads/Gg*fastq.gz | cut -d '/' -f9 | sed s/.fastq.gz//) )
...
hisat2 \
	...
	--novel-splicesite-infile $SGE_O_HOME/projects/evo.devo/processed/mapping/junctions/chicken.spMerged.filtered.splicesites \
